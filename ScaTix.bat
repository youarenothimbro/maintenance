@echo off
title ScaTix maintenance
color 5
echo MADE BY S C A T I X
echo.
pause
...
set "RestorePointName=ScaTixRestorePoint"
...
:information
echo.
echo Please do not steal this tool to your own! Thx!
echo.
echo If you have any quesions DM me on Discord!
echo Discord Name: vs_scatix
echo.
echo If you doesnt trust my Tool it with the standard windows editior! :)
echo.
